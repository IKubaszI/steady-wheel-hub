...
export const receipts: Receipt[] = [
  { id: "r1",  vehicleId: "v1", vendor: "Supercharger Station", category: "fuel",      amount: 24.30, date: "2026-05-02" },
  { id: "r2",  vehicleId: "v2", vendor: "Shell Premium",        category: "fuel",      amount: 62.80, date: "2026-05-01" },
  { id: "r3",  vehicleId: "v3", vendor: "BMW Dealer Parts",     category: "parts",     amount: 318.40, date: "2026-04-28" },
  { id: "r4",  vehicleId: "v4", vendor: "Mike's Auto Service",  category: "service",   amount: 240.00, date: "2026-04-22" },
  { id: "r5",  vehicleId: "v1", vendor: "GEICO",                category: "insurance", amount: 162.00, date: "2026-04-15" },
  { id: "r6",  vehicleId: "v2", vendor: "AutoZone",             category: "parts",     amount: 84.20,  date: "2026-04-12" },
  { id: "r7",  vehicleId: "v3", vendor: "Detail Pros",          category: "other",     amount: 220.00, date: "2026-04-09" },
  { id: "r8",  vehicleId: "v4", vendor: "Costco Gas",           category: "fuel",      amount: 71.10,  date: "2026-04-05" },
  { id: "r9",  vehicleId: "v2", vendor: "Allstate",             category: "insurance", amount: 148.00, date: "2026-03-28" },
  { id: "r10", vehicleId: "v3", vendor: "Quick Lube",           category: "service",   amount: 95.50,  date: "2026-03-21" },
  { id: "r11", vehicleId: "v1", vendor: "Tire Rack",            category: "parts",     amount: 612.00, date: "2026-03-12" },
  { id: "r12", vehicleId: "v4", vendor: "Shell Premium",        category: "fuel",      amount: 78.40,  date: "2026-03-04" },
];
