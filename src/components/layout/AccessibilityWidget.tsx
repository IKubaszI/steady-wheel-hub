        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2 pt-2 border-t border-border/60">
            ...
            >
              <ToggleGroupItem
                value="normal"
                className="text-[11px] h-8 font-medium rounded-lg data-[state=on]:bg-accent data-[state=on]:shadow-sm data-[state=on]:text-accent-foreground"
              ...
              <ToggleGroupItem
                value="large"
                className="text-xs h-8 font-semibold rounded-lg data-[state=on]:bg-accent data-[state=on]:shadow-sm data-[state=on]:text-accent-foreground"
              ...
              <ToggleGroupItem
                value="xl"
                className="text-sm h-8 font-bold rounded-lg data-[state=on]:bg-accent data-[state=on]:shadow-sm data-[state=on]:text-accent-foreground"
