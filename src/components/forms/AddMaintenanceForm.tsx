  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-4">
        ...
        <Field id="type" label="Service type"><Input id="type" value={type} onChange={(e) => setType(e.target.value)} placeholder="Oil change" /></Field>
      ...
      <Field id="notes" label="Notes"><Textarea id="notes" value={notes} onChange={(e) => setNotes(e.target.value)} rows={3} placeholder="Synthetic 5W-30, check brakes…" /></Field>
